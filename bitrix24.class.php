		...
		*/
		public function checkRequests(){
			...
			*/
			...
			/*
				В $tmp_result имеем только те заявки, которые можно взять в работу
				Формируем итоговые массив
			*/
			...
			$this->AWAIBLE_REQUESTS = count($arResult); // Количество доступных заяков
